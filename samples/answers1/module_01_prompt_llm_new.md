...
### Q17：AI Agent 开发一面中，为什么会追问微调和强化学习？这些和项目经验如何关联？

**考察点**

考察候选人在Prompt / LLM 原理类上的理解深度，尤其是概念边界、参数影响、训练或推理机制，以及能否结合业务约束做取舍。
...
### Q19：LoRA 是如何实现高效微调的？它和全量微调相比优势在哪里？
...
### Q20：针对法律等特定领域微调大模型，需要准备什么样的数据？数据质量对微调结果影响有多大？
...
### Q21：Temperature=0 时，为什么大模型输出结果仍可能不完全一致？
...
### Q22：为什么 Transformer 架构在处理超长上下文时会变慢？
...
### Q23：Prompt Engineering 与 Context Engineering 的核心区别是什么？
...
### Q24：大模型推理具体怎么做？temperature、top_p、top_k、frequency penalty、presence penalty 分别影响什么？
...
### Q25：SFT、RLHF、DPO、PPO、GRPO 在 Agentic Post-training 中分别解决什么问题？
...
### Q26：LoRA、P-Tuning 等参数高效微调方法的原理和适用场景是什么？
...
### Q27：长上下文模型最终会杀死 RAG 吗？什么时候仍然需要 RAG？
...
### Q28：Multi-Agent、Context Engineering、ReAct/PlanAct/CodeAct 在内容治理、搜索推荐等场景中如何选型？
