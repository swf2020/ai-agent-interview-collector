...
### Q13：Function Calling 是怎么设计的？

**考察点**

考察候选人在工具调用类上的理解深度，尤其是工具协议、参数约束、调用路由、安全边界和错误恢复设计。
...
### Q17：Skill 你了解吗？用过吗？底层怎么实现的？渐进式披露的原理是什么？
...
### Q19：Function Call 的原理是什么？模型生成的 JSON 怎么触发表层代码执行，再把结果返回给模型？
...
### Q20：设计 Agent 工具调用能力时，你的技术方案是什么？如何选择合适的工具 API？
...
### Q21：LangChain、MCP、LangGraph 如何选择？
...
### Q23：MCP 协议 + Function Calling 如何从入门到实战打通大模型工具调用？
...
### Q24：Tool Call 是如何实现的？模型怎么知道该调用哪个工具？
...
### Q25：Tool Call 和 Agent 的区别是什么？为什么 Tool Call 只是单一能力，而 Agent 是完整系统？
...
### Q26：MCP 还是 CLI？在 Agent 工具体系中如何选择？
...
### Q27：Skill 太多塞进 System Prompt 会有什么问题？如何处理？
...
### Q28：大模型 Function Calling 到底是怎么实现的？底层原理是什么？
...
### Q29：MCP 了解过吗？它和 Function Calling 的区别是什么？
...
### Q30：Agent 交互协议 MCP、A2A、FunctionCall 分别解决什么问题？如何在系统中协同？
...
### Q31：Function Call、MCP、Skills 三者区别与协作关系是什么？
...
### Q32：MCP 基于什么协议实现？本地 stdio、远程 HTTP + SSE、JSON-RPC 2.0 各自承担什么角色？
...
### Q33：A2A 协议是什么？为什么 MCP 不能替代 A2A？
...
### Q34：Multi-Agent 是什么？和 Agent Skills 在本质层面与代码层面有什么区别？
...
### Q35：Agent 生产环境常见坑有哪些？死循环、幻觉工具调用、上下文污染、Token 爆炸、Prompt Injection 如何处理？
...
### Q36：Agent Skills 技术为什么在 2026 年成为高频方向？它和传统 Agent 框架的关系是什么？
...
### Q37：为什么说 2026 年一线大厂已经把 MCP、A2A、Skills 等新协议纳入 AI 应用开发面试重点？
